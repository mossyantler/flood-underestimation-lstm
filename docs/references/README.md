...
이 폴더는 외부 문헌, 강의, glossary, 보조 학습 노트를 현재 CAMELS 연구 맥락으로 정리하는 곳이다. 공식 방법론의 source of truth는 [`../experiment/method/`](../experiment/method/)에 둔다.

## Areas

- [`basin/`](basin/): basin shape, river network, screening 해석에 필요한 배경지식
- [`method/`](method/): LSTM hydrology, hyperparameter glossary, related-work map
- [`analysis/`](analysis/): flood-generation typing, event stratification, 결과 해석 관련 문헌
...
참고 노트에서 얻은 아이디어가 실제 기준으로 승격되면, 해당 내용을 [`../experiment/method/`](../experiment/method/) 문서에 다시 반영한다.
