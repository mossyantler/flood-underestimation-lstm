...
이 문서는 공식 실험 규칙을 대체하지 않는다. 공식 비교축과 실행 기준은 [`../../experiment/method/model/experiment_protocol.md`](../../experiment/method/model/experiment_protocol.md)를 우선한다. 다만 실험을 설계하거나 설명할 때, parameter의 의미를 정리한 참고 사전으로 쓸 수 있다.
...
비교 실험에서는 “어떤 값을 튜닝할 수 있는가”보다 “어떤 값을 절대 바꾸면 안 되는가”를 먼저 정해야 한다. 현재 프로젝트의 공식 규칙은 [`../../experiment/method/model/experiment_protocol.md`](../../experiment/method/model/experiment_protocol.md)의 `Model 1 vs Model 2 공식 통제변인` 섹션을 따른다.
...
- [`../../experiment/method/model/experiment_protocol.md`](../../experiment/method/model/experiment_protocol.md): 공식 config key 대응과 실행 규칙
- [`../../archive/proposals/research-plan-extreme-flood-underestimation.md`](../../archive/proposals/research-plan-extreme-flood-underestimation.md): 현재 연구계획서 초안
- [`../../archive/proposals/research-proposal-submission-draft.md`](../../archive/proposals/research-proposal-submission-draft.md): 제출용 연구계획서 초안
