...
| 지표 | 심볼 | 변수명 | 범위 | 최적화 방향 |
| --- | --- | --- | --- | --- |
| 첨두 모자람 | α | `rq2_alpha_event_peak_deficit` | 0~1 | 작을수록 좋음 ↓ |
| 첨두 부근 덮음 | β | `rq2_beta_window_capture` | 0~(1 초과 가능) | 1에 가까울수록 좋음, 너무 크면 과대 |
| 큰 물 시각 덮음(recall) | δ | `rq2_delta_threshold_recall` | 0~1 | 클수록 좋음 ↑ |
...
#### 과소추정 사건 vs 과대추정 사건 — 변수 종류 차이는 작다
