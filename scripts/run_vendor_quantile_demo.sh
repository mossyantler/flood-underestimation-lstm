...
python -m neuralhydrology.nh_run train \
  --config-file "$ROOT_DIR/configs/camels_us_01022500_daymet_quantile.yml"

LATEST_RUN="$(find "$ROOT_DIR/runs" -maxdepth 1 -mindepth 1 -type d -name 'camels_us_01022500_daymet_quantile_[0-9][0-9][0-9][0-9]_[0-9][0-9][0-9][0-9][0-9][0-9]' | sort | tail -n 1)"
