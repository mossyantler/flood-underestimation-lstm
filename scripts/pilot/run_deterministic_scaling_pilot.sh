...
for SIZE in "${SIZES[@]}"; do
  ...
  for SEED in "${SEEDS[@]}"; do
    ...
    export BASE_CONFIG TMP_CONFIG SEED SIZE PILOT_EPOCHS PILOT_NUM_WORKERS PILOT_CACHE_VALIDATION PILOT_DEVICE PILOT_SAVE_ALL_OUTPUT PILOT_SAVE_VALIDATION_RESULTS PILOT_EXPERIMENT_SUFFIX PILOT_RESUME ROOT_DIR
    RESUME_INFO="$(
      python - <<'PY'
import os
import shlex
