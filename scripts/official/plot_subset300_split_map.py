...
def conus_bounds() -> tuple[float, float, float, float]:
    transformer = Transformer.from_crs("EPSG:4326", TARGET_CRS, always_xy=True)
    corners = [
        transformer.transform(-125.5, 24.0),
        transformer.transform(-66.0, 24.0),
        transformer.transform(-66.0, 50.0),
        transformer.transform(-125.5, 50.0),
    ]
