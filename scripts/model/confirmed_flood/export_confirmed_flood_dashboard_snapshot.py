...
DEFAULT_PERF_CSV = ROOT / "output/model_analysis/confirmed_flood/tables/drbc_confirmed_flood_performance.csv"
DEFAULT_EVENT_WINDOWS = ROOT / "output/model_analysis/confirmed_flood/data/inference/confirmed_flood_event_windows_used.csv"
