...
- [`run_subset300_multiseed.sh`](/Users/jang-minyeop/Project/CAMELS/scripts/official/run_subset300_multiseed.sh): 현재 채택된 `scaling_300` subset을 고정하고, Model 1 / Model 2의 seed `111 / 222 / 333` main comparison을 같은 basin file로 반복 실행하는 공식 runner다.
