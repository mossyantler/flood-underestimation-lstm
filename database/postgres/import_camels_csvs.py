...
PRIMARY_DELTAS = Path("output/model_analysis/overall_analysis/main_comparison/tables/primary_epoch_basin_deltas.csv")
BASIN_MEMBERSHIP = Path("output/model_analysis/natural_broad_comparison/tables/basin_membership.csv")
EXTREME_RAIN_EVENTS = Path("output/model_analysis/extreme_rain/primary/exposure/extreme_rain_event_catalog.csv")
...
PROB_PINBALL = Path("output/model_analysis/probabilistic_diagnostics/quantile_pinball_summary.csv")
PROB_CALIBRATION = Path("output/model_analysis/probabilistic_diagnostics/quantile_calibration_summary.csv")
PROB_TAIL_SPREAD = Path("output/model_analysis/probabilistic_diagnostics/upper_tail_spread_summary.csv")
